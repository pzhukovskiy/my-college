    ...
    Scaffold(
        content = { paddingValues ->
            if (viewModel.errorMessage.isBlank()) {
                Column {
                    StaticHeaderWidget(
                        text = stringResource(id = R.string.link_employee_ahch),
                    ...
                    TextField(
                        ...
                        onValueChange = {
                            query = it
                            viewModel.filterEmployeeAhchByFIO(it)
                        },
                    ...
                    LazyColumn(content = {
                        items(viewModel.filteredEmployeesAhchList) { employee ->
                            Box(
                                modifier = Modifier
                                    .fillMaxWidth()
                                    .height(180.dp)
                                        ...
                                        Column {
                                            ...
                                            Box(
                                                ...
                                                Box(modifier = Modifier
                                                    ...
                                                    .fillMaxWidth()
                                                    .clickable {
                                                        navController.navigate("${NavigationItem.DetailEmployeesAHCH.route}/${employee.id}")
                                                    },
                                                    contentAlignment = Alignment.Center
                                                ) {
                                                    Text(
