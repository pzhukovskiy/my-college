            ...
            if (viewModel.errorMessage.isBlank()) {
                Column {
                    ...
                    TextField(
                        ...
                        onValueChange = {
                            query = it
                            viewModel.filterAdministratorByFIO(it)
                        },
                        label = { Text(stringResource(id = R.string.search_administration)) },
                        modifier = Modifier
                    ...
                    LazyColumn(content = {
                        items(viewModel.filteredAdministratorList) { administrator ->
                            Box(
                                modifier = Modifier
                                    .fillMaxWidth()
                                    .height(180.dp)
